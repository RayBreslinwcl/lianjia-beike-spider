...
from lib.item.ershou_each import *
    ...
    def get_area_ershou_info(city_name, area_name):
        ...
        for num in range(1, total_page + 1):
            ...
            for house_elem in house_elements:
                ...
                #新添加
                interest=re.findall("\d+",house_elem.find('div', class_="followInfo").text.split('/')[0])
                publicday=re.findall("\d+",house_elem.find('div', class_="followInfo").text.split('/')[1])
                xiaoqu=house_elem.find('div', class_="positionInfo").find('a').text
